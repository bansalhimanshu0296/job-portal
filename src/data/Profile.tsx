...
const fields=[
    ...
    {label:"Organization",placeholder:"Enter Organization Name", options:['Google', 'Microsoft', 'Meta', 'Netflix', 'Adobe', 'Facebook', 'Amazon', 'Apple', 'Spotify'],value:"Google", leftSection:IconBriefcase},
