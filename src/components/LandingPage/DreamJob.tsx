    ...
    return (
        <div className="flex items-center px-16 pt-16"> 
            <div className="flex flex-col w-[45%] gap-3">
                <div className="text-6xl font-bold leading-tight text-mine-shaft-100 [&>span]:text-bright-sun-450">Find your <span>dream job </span>with us</div>
                ...
                <div className="flex gap-3 mt-5">
                    ...
                    <div className="flex items-center justify-center h-full w-20 bg-bright-sun-450 text-mine-shaft-100 rounded-lg p-2 hover:bg-bright-sun-500 cursor-pointer">
            ...
            <div className="w-[55%] flex items-center justify-center">
                <div className="w-[30rem] relative">
                    ...
                    <div className="absolute -right-10 w-fit top-[50%] border-bright-sun-450 border rounded-lg p-2 backdrop-blur-md">
                    ...
                    <div className="absolute -left-5 w-fit top-[28%] border-bright-sun-450 border rounded-lg p-2 backdrop-blur-md gap-3 flex flex-col">
