...
const JobCategories = () => {
    return <div className="mt-20 pb-5">
        <div className="text-4xl text-center font-semibold text-mine-shaft-100 mb-3">
            Browse <span className="text-bright-sun-450">Job</span> Category
        </div>
        ...
        <Carousel
            ...
            className="focus-visible:[&_button]:!outline-none [&_button]:!bg-bright-sun-450 [&_button]:!border-none hover:[&_button]:!opacity-75 [&_button]:!opacity-0 [&_button:hover]:!opacity-100"
            nextControlIcon={<IconArrowRight className="h-8 w-8" />}
            previousControlIcon={<IconArrowLeft className="h-8 w-8" />}
        >
            {
                jobCategories.map((category, index) => <Carousel.Slide key={index}>
                    <div className="flex flex-col items-center w-64 gap-2 border border-bright-sun-450 p-5 rounded-xl hover:cursor-pointer hover:shadow-[0_0_5px_2px_black] my-5 transition duration-300 ease-in-out !shadow-bright-sun-300">
