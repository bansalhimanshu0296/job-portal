            ...
            <Tabs variant="outline" radius="lg" defaultValue="applied">
                ...
                <Tabs.Panel value="applied">
                    <div className="mt-10 flex flex-wrap gap-10">
                        {
                            jobList.map((job, index) => <JobCard key={index} {...job} applied />)
                        }
                    </div>
                </Tabs.Panel>
                <Tabs.Panel value="saved">
                    <div className="mt-10 flex flex-wrap gap-10">
                        {
                            jobList.map((job, index) => <JobCard key={index} {...job} saved />)
                        }
                    </div>
                </Tabs.Panel>
                <Tabs.Panel value="offered">
                    <div className="mt-10 flex flex-wrap gap-10">
                        {
                            jobList.map((job, index) => <JobCard key={index} {...job} offered/>)
                        }
                    </div>
                </Tabs.Panel>
